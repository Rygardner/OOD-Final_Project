...
class level_select_buttons:
    def __init__(self):
        self.level_select_buttons = [
            button(level_select_rects , "1" , BLACK , GRAY , 36), 
            button(level_select_rects , "2" , BLACK , GRAY , 36),
            button(level_select_rects , "3" , BLACK , GRAY , 36),
            
            button(level_select_rects , "4" , BLACK , GRAY , 36),
            button(level_select_rects , "5" , BLACK , GRAY , 36),
            button(level_select_rects , "6" , BLACK , GRAY , 36),
            
            button(level_select_rects , "X" , BLACK , RED , 36)
        ]
